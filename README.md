...
1. `material/stundenplanung.md` gibt dir den Überblick über die Reihe und die Anbindung an den Bildungsplan BW 2016.
2. `material/verlaufsplaene.md` enthält detaillierte Verlaufspläne für 4 x 45 Minuten.
3. `material/beobachtungsbogen.md` bietet ein einfaches Tool zur Diagnose und Rückmeldung.
4. `material/bewertung_rubric.md` schlägt ein Raster zur Leistungsbewertung vor.

## 🖼️ Bilder & Medien
Im Ordner `bilder/` kannst du eigene Fotos aus dem Unterricht oder lizenzfreie Grafiken ablegen.
